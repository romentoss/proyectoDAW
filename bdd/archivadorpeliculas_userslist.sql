...
CREATE TABLE `userslist` (
  ...
  CONSTRAINT `userslist_ibfk_1` FOREIGN KEY (`emailUser`) REFERENCES `usersfilmshared` (`email`)
...
INSERT INTO `userslist` VALUES (1,'listapruba1','prueba1@prueba.com'),(4,'PruebaVacia','culo@gmail.com'),(52,'prueba2','prueba1@prueba.com'),(56,'culo','romentos@test.com');
